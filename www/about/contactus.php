  ...
  <tr>
    ...
    <td height="59" align="left" background="../inc/pics/bg004.jpg"><table width="100%" border="0" cellspacing="4" cellpadding="4" class="txt" >
      <tr>
        ...
        <td width="93%">您现在的位置：<a href="/" class="link_navi">首页</a> &gt; 联系我们  </td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td width="757" height="630" align="right" valign="top"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" valign="top" class='txt'><?php echo $page_content[content];?>
       <?=$setinfo[mapcode];?>     </td>
        </tr>
      <tr>
        <td height="40" align="center" valign="top" class='txt'>&nbsp;</td>
      </tr>
    </table>
    </td>
  </tr>
